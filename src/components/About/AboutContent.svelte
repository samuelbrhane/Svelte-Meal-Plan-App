<section class="bg-[#cfcccf] h-[400px] mt-10 md:mt-20 mb-20">
  <div
    class="max-w-6xl mx-auto px-3 grid grid-cols-1 md:grid-cols-2 h-full gap-4 md:gap-12 lg:gap-20 xl:gap-24"
  >
    <div class="h-full">
      <h1>Why we do it.</h1>
      <p>
